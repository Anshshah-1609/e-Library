					...
					<li>
						<div class="row" id="row1">
							<div class="col-md-3">
								<div class="file-left">
									<a href="/living-in-the-light-a-guide-to-personal-transformation-e10172273.html" data-id="10172273">
										<img class="img-zoom file-img" src="{{'http://127.0.0.1:8000/bookimages/' . $book->bcover}}" id="img4">
									</a>
							...
							<div class="col-md-6">
								...
								<button type="button" value="Download" id="btn3">
								<a href="http://127.0.0.1:8000/bookpdf/{{$book->bpdf}}" download style="color:white">Download</a>
								</button>
